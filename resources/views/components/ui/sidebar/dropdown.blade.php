...
>
    <button
        ...
        class="w-full flex items-center justify-between gap-3 px-4 py-2 rounded-md hover:bg-gray-100 font-medium text-gray-700 dark:text-gray-300 dark:hover:bg-gray-700 transition text-left cursor-pointer"
