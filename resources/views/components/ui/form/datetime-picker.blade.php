...
<div x-data="dateTimePicker(@js($value))" x-cloak {{ $attributes->only('class') }}>
    ...
    <div class="relative">
        ...
        <div x-show="open" x-transition @click.away="open = false" x-ref="dropdown"
               ...
               // round minutes to nearest 5 given we only allow selection of 5 min intervals
                ...
                if (this.$watch) {
                    ...
                    this.$watch('open', (isOpen) => {
                        if (isOpen) this.scrollDropdownIntoView();
                    });
                }
            },
