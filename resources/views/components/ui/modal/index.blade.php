...
>
    ...
    >
        ...
        <!-- Modal content  - added overflow-auto to allow scrolling -->
        <div {{ $attributes->class(['relative p-6 m-6 bg-white dark:bg-gray-800 rounded-lg overflow-auto shadow-xl sm:w-full' , $maxWidth, 'sm:mx-auto z-50']) }}
            @click.stop
            x-transition:enter="ease-out duration-300"
